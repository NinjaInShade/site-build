      ...
      {site ? (
        <>
          <div className="site-dashboard-header">
            <svg className="site-dashboard-circle" width="66" height="65" viewBox="0 0 66 65" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              return (
                <div className="site-dashboard-topics-container" key={index}>
                  ...
                  {topic.data.map((accordion_data, index) => {
                    return (
                      <Accordion priority={accordion_data.priority} title={accordion_data.heading} key={index} checked={accordion_data.checked}>
